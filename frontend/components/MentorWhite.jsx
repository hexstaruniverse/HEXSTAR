...
export default function MentorWhite(props) {
  return (
    <div className={`${props.className} text-[#1B1B1B] rounded-lg flex-col items-center w-36 h-52 md:w-64 md:h-80 border-[#1B1B1B] border-2`}>
        ...
        />
        <br/>
        <div className='flex items-center justify-center h-8 px-5 mb-1 text-xs font-bold capitalize  border-[#1B1B1B] border-2 rounded-md w-28 md:w-2/3 md:text-base md:h-10 '>{props.mentorName}</div>
